# Stealth
If you want to run a "stealth" auto stream you must hide player names and `Waiting For Game` in Playback Slippi Dolphin (see below). You should also use the "Stealth" option with Auto Stream for Slippi's Twitch bot (see below).
